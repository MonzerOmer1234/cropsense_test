...
<body>
    ...
    <div class="row">
        <div class="d-md-none">
            <button class="btn m-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop"
            ...
            <div class="offcanvas offcanvas-start" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop"
                aria-labelledby="staticBackdropLabel" style="width : 200px">
               
                <div class="offcanvas-body sidebar">
                    <aside class="sidebar-nav-wrapper"
                        style="transform: translateX(0) !important ; display : block !important">
                        ...
                        <nav class="sidebar-nav">
                            <ul>
                                ...
                                <li class="nav-item nav-item">
                                    <a href="{{ route('workers.index') }}" aria-controls="ddmenu_2"
                                ...
                                {{-- Tasks --}}
                                <li class="nav-item nav-item">
                                    <a href="{{ route('tasks.index') }}" aria-controls="ddmenu_2"
                                        aria-expanded="false" aria-label="Toggle navigation">
                                        <span class="icon">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-2 px-0 d-md-none">
            <aside class="sidebar-nav-wrapper" style="transform: translateX(0) !important ; ">
